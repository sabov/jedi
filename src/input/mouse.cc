...
glm::dvec2 Mouse::initialPosition;
glm::dvec2 Mouse::movement;
glm::dvec2 Mouse::movementScale;
bool Mouse::rightMouseButtonDown = false;
bool Mouse::leftMouseButtonDown = false;
bool Mouse::mouseWheelScrollUp = false;
bool Mouse::mouseWheelScrollDown = false;

Mouse::Mouse(GLFWwindow* window, ACGL::HardwareSupport::SimpleRiftController *simpleRiftController, World *world) :
